...
export class JmshomePage {
  ...
  ngOnInit() {
    ...
    this.myplan = this.sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/icons/business-plan.png');
    this.plan = this.sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/icons/add.png');
    this.faqs = this.sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/icons/faq.png');
    this.pay = this.sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/icons/pay.png');
