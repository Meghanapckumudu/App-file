...
export class TestpayPage {
  ...
  razorpay() {
    let rp_obj = {
      ...
      rpay_imgpath:
        "https://kumuduapps.in:8443/logo/" + this.data.storeID + "/favicon.png",
    ...
    let pg_obj = {
      ...
      customerMobileNumber: "9731552442",
      name: "Pallavi",
      chqNo: "123",
      ...
      if (this.rozar_orderId.length > 0) {
        ...
        if (this.data.razorpay_std == "0") {
          ...
          pageContent =
            ...
            this.data.razorpay_callbackurl +
            '">' +
            "<button>Submit</button> </form> " +
          ...
          console.log(
            "this.data.razorpay_std Generic : " + this.data.razorpay_std
          );
