...
export class membersendsmsPage {
  ...
  ionViewDidEnter() {
    this.subscription = this.plt.backButton.subscribe(() => {
      ...
      // Navigate back to the previous page (adjust the route as needed)
      this.router.navigate(["/previous-page"]); // Replace '/previous-page' with the actual route you want to navigate to
    });
  }
