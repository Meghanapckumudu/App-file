...
export class DashboardPage {
  ...
  GoTOPaymentMode() {
    ...
    this.router.navigate(["/chit-list"]); // Replace with your actual route for ChitListPage
  }
  goToSchemeDetail() {
    console.log("goToSchemeDetail");
    this.router.navigate(["/scheme-detail"]); // Replace with your actual route for SchemeDetailPage
  }
  reports() {
  ...
  goToMemberUpdate() {
    this.router.navigate(["/member-update"]);
  }
  payResponse = "";

  dojoinscheme() {
    this.router.navigate(["/chit-list"]); // Update with your actual route path for SearchPage
  }
  goToMyChits() {
    this.router.navigate(["/search"]); // Update with your actual route path for SearchPage
  }
